...
export const mockDepartments: PublicDepartmentProfile[] = [
  ...
  },
  {
    ...
    badgeCreditsSent: 0,
    profileIntro: "Pending department registration awaiting GetBadged review.",
    activeJobCount: 0,
    departmentType: "Municipal Police Department",
    hiringTimeline: "Pending approval",
    openPositions: "Pending approval",
    chiefName: "Pending review",
    chiefSwornIn: "Pending review",
    population: "Pending review",
    departmentSize: "Pending review",
    patrolOfficers: "Pending review",
    callVolume: "Pending review",
    communityType: "Pending review",
    badgeImageUrl: "",
    whyJoin: [],
    media: [],
    sections: [],
