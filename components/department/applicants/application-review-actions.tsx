...
function buildApplicationPackage(model: DepartmentApplicationDetailViewModel) {
  ...
  return [
    ...
    "--------------------------",
    `Email: ${model.contactAccess.isContactHidden ? "Hidden by contact visibility rules" : candidate.email}`,
    `Phone: ${model.contactAccess.isContactHidden ? "Hidden by contact visibility rules" : candidate.phone}`,
    `Location: ${model.contactAccess.isContactHidden ? "Hidden by contact visibility rules" : `${candidate.city}, ${candidate.state} ${candidate.zipCode}`}`,
