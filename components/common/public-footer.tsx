...
export function PublicFooter() {
  return (
    <footer className="mt-auto bg-[color:var(--navy)] text-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 py-8 text-sm md:flex-row md:items-center md:justify-between">
        <Logo inverted />
      ...
      <div className="mx-auto flex max-w-7xl justify-between border-t border-white/10 px-4 sm:px-6 py-4 text-xs text-white/70">
