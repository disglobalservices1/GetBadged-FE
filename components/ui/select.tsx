  ...
  return (
    <label className="grid gap-2 text-sm font-semibold text-slate-700" htmlFor={inputId}>
      ...
      <select
        id={inputId}
        className={cn(
          "min-h-11 rounded-md border border-[color:var(--border)] bg-white px-3 text-sm text-slate-950 outline-none transition focus:border-[color:var(--blue)] focus:ring-2 focus:ring-[rgba(27,51,181,0.12)]",
